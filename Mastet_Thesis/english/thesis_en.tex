...
\begin{figure}[H]
	...
	\caption{Bloch sphere representation of a qubit \cite{bib:schuld_petruccione}
	}
...
\begin{figure}[H]
	...
	% Place caption under the figure
	\caption{An example of a quantum circuit diagram \cite{bib:bsc_thesis}
	}
	% Label the caption to include in the list of figures
...
\begin{figure}[H]
	...
	% Place caption under the figure
	\caption{General structure of a variational quantum circuit \cite{bib:bsc_thesis}
	}
	% Label the caption to include in the list of figures
...
Breast cancer is the most common malignancy among women worldwide, accounting for approximately 36\% of all oncological cases \cite{bib:who} with numerous machine learning algorithms have been applied to support the prognosis of breast cancer tissues [2]. Breast cancer is also the most prevalent malignant tumor worldwide, with an estimated 2.089 million women diagnosed in 2018, and its incidence continues to rise across all regions of the globe \cite{bib:who}. The highest incidence rates are observed in industrialized countries, a trend commonly associated with factors such as unhealthy dietary habits, nicotine use, chronic stress, and low levels of physical activity.
...
\begin{figure}
	...
	% Place caption under the figure
	\caption{A magnified image of a malignant breast FNA with the visible cell nuclei having been outlined with the help of a curve fitting program \cite{bib:fna_image}.
	}
	% Label the caption to include in the list of figures
	\label{fig:nuclei}
\end{figure}
