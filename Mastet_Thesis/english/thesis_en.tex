...
\hypersetup{
    ...
    pdfsubject={MSc Thesis for DSIT}               % subject of the document
}
\urlstyle{same}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%% User-specific package inclusions %%%%%%%%%%%%%%%%%%%%%%%%%
...
%
\programGr{ΔΙΑΤΜΗΜΑΤΙΚΟ ΠΡΟΓΡΑΜΜΑ ΜΕΤΑΠΤΥΧΙΑΚΩΝ ΣΠΟΥΔΩΝ\\
	"EΠΙΣΤΗΜΗ ΔΕΔΟΜΕΝΩΝ ΚΑΙ ΤΕΧΝΟΛΟΓΙΕΣ ΠΛΗΡΟΦΟΡΙΑΣ"\\
	ΕΙΔΙΚΕΥΣΗ\\
	"ΒΙΟΠΛΗΡΟΦΟΡΙΚΗ – ΕΠΙΣΤΗΜΗ ΒΙΟΪΑΤΡΙΚΩΝ ΔΕΔΟΜΕΝΩΝ"}
\programEn{INTERDISCIPLINARY MSc PROGRAM\\
...
\advisorRankGr{Δόκτωρ,}
\advisorOrgGr{\\Τμήμα Πληροφορικής και Τηλεπικοινωνιών,\\ Εθνικό και Καποδιστριακό Πανεπιστήμιο Αθηνών}
\advisorEn{Mandilara Aikaterini}
\advisorRankEn{Doctor,}
\advisorOrgEn{\\Department of Informatics and Telecommunications,\\ National and Kapodistrian University of Athens}
...
\boardTwoOrgGr{\\Τμήμα Πληροφορικής και Τηλεπικοινωνιών,\\ Εθνικό και Καποδιστριακό Πανεπιστήμιο Αθηνών}
\boardTwoEn{Gunopulos Dimitrios}
\boardTwoRankEn{Professor,}
\boardTwoOrgEn{\\Department of Informatics and Telecommunications,\\ National and Kapodistrian University of Athens}

\boardThreeGr{Συβρίδης Δημήτριος}
\boardThreeRankGr{Καθηγητής,}
\boardThreeOrgGr{\\Τμήμα Πληροφορικής και Τηλεπικοινωνιών,\\ Εθνικό και Καποδιστριακό Πανεπιστήμιο Αθηνών}
\boardThreeEn{Syvridis Dimitrios}
\boardThreeRankEn{Professor,}
\boardThreeOrgEn{\\Department of Informatics and Telecommunications,\\ National and Kapodistrian University of Athens}

%
% The examination date of the thesis
%
\examinationDateGr{2 Μαρτίου 2026}
\examinationDateEn{2 March, 2026}

%
% Supervisors[heading(optional, defaluts to ΕΠΙΒΛΕΠΩΝ/SUPERVISOR)]{people} (greek and english)
%
\supervisorsGr[Επιβλέπουσα]{
    {\bfseries Μανδηλαρά Αικατερίνη} Δόκτωρ, \\Τμήμα Πληροφορικής και Τηλεπικοινωνιών,\\ Εθνικό και Καποδιστριακό Πανεπιστήμιο Αθηνών\\
    % {\bfseries Επιβλέπων Δεύτερος}, Καθηγητής ΕΚΠΑ
}
\supervisorsEn[Supervisor]{
    {\bfseries Mandilara Aikaterini} Doctor, \\Department of Informatics and Telecommunications,\\ National and Kapodistrian University of Athens\\
...
\abstractEn{%
Breast cancer accounts for 36\% of female oncological cases, necessitating high-precision prognostic tools. While traditional machine learning is the standard, this study explores the efficacy of Variational Quantum Classifiers (VQCs) using breast tumor data from fine-needle aspirates. By integrating Principal Component Analysis (PCA), we managed the tradeoff between explained variance and the dimensions of the Hilbert space traversed by the quantum processor. The findings reveal that a 4-qubit configuration utilizing 16 principal components captured nearly 99\% of data variance, consistently achieving classification scores above 90\%. This performance demonstrates that even small-scale quantum circuits can remain competitive with sophisticated classical methods like Logistic Regression. Ultimately, the study highlights how hybrid quantum-classical pipelines with a small number of qubits can leverage quantum advantages to provide robust, scalable solutions for complex medical diagnostics.
}
...
\begin{equation}
	\hat{Y}\ket{0} = -i\ket{1},   \hat{Y}\ket{1} = i\ket{0}
	\label{eq:operator_Y}
\end{equation}
...
\begin{figure}
	% Define thefigure file in the \includegraphics command
	% Must be relative to one of the paths
	% in the \graphicspath command at the top
